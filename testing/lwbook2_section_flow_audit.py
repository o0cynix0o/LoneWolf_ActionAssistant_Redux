...
MANUAL_ROUTE_AUDIT: dict[str, dict[str, Any]] = {
    ...
    "240": {"sourceRoutes": [route_action(29, [{"type": "stat", "stat": "end", "mode": "restore_max", "condition": cond_power("Healing")}, {"type": "stat", "stat": "end", "mode": "restore_missing_half_floor", "condition": cond_no_power("Healing")}], "Recover after the fire"), route_action(236, [{"type": "stat", "stat": "end", "mode": "restore_max", "condition": cond_power("Healing")}, {"type": "stat", "stat": "end", "mode": "restore_missing_half_floor", "condition": cond_no_power("Healing")}], "Recover after the fire"), route_action(101, [{"type": "stat", "stat": "end", "mode": "restore_max", "condition": cond_power("Healing")}, {"type": "stat", "stat": "end", "mode": "restore_missing_half_floor", "condition": cond_no_power("Healing")}], "Recover after the fire")]},
