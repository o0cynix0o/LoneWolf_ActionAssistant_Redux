...
MANUAL_COMBAT_AUDIT: dict[str, dict[str, Any]] = {
    "20": {"combat": [combat_preset(20, "Horseman", combat_enemy("Horseman", 21, 28), canEvade=True, evadeRoute=142, winWithinRounds=3, winWithinRoute=125, tooLateRoute=82, defeatRoute=161, restoreHalfPlayerEnduranceLossAfterCombat=True)]},
    ...
    "119": {"combat": [combat_preset(119, "Palace Gate Guardians", combat_enemy("Palace Gate Guardians", 16, 30), ignorePlayerLossRounds=3, victoryRoute=188)]},
    ...
    "159": {"combat": [combat_preset(159, "Armoury Guard", combat_enemy("Armoury Guard", 16, 22), timedModifiers=[{"startRound": 1, "endRound": 3, "modifier": -2}], victoryRoute=111)]},
    ...
    "264": {"combat": [combat_preset(264, "Vordak", combat_enemy("Vordak", 17, 26), enemyImmune=True, victoryRoute=319, preActions=[{"type": "stat", "stat": "end", "delta": -2, "condition": cond_no_power("Mindshield")}])]},
    "280": {"combat": [combat_preset(280, "Drakkar", combat_enemy("Drakkar", 18, 25), ignorePlayerLossRounds=1, victoryRoute=288)]},
    ...
    "355": {"combat": [combat_preset(355, "Vordak", combat_enemy("Vordak", 17, 26), enemyImmune=True, victoryRoute=249)]},
    "357": {"combat": [combat_preset(357, "Platform Sentry", combat_enemy("Platform Sentry", 15, 23), victoryRoute=323)]},
    "370": {"combat": [combat_preset(370, "Itikar", combat_enemy("Itikar", 17, 30), doubleEnemyLoss=True, victoryRoute=217)]},
    "393": {"combat": [combat_preset(393, "Drakkar", combat_enemy("Drakkar", 16, 25), timedModifiers=[{"startRound": 1, "endRound": 1, "modifier": -2}], preActions=[{"type": "stat", "stat": "end", "delta": -2, "condition": cond_no_power("Mindshield")}], victoryRoute=288)]},
}
...
def classify_section(block: str, routes: list[int], section: int) -> list[str]:
    ...
    if any(term in text for term in ("your life end", "your adventure ends", "you are dead", "your life and the hopes")):
        add("terminal_death")
