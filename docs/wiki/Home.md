...
This wiki is the player-facing companion to the local web assistant. We use it to explain how the app works, what Book 1 can do today, where Book 2 setup stands, and how to keep your own Project Aon book files local and private.
