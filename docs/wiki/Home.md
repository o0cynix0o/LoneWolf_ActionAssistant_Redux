...
Book 4 and later will be added one at a time through the book pipeline so new rules, carry-over choices, powers, gear, and section logic get proper attention.
