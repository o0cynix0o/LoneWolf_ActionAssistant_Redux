...
Book 2 and later campaign transitions are future pipeline work. Each later book needs its own rules scan, carry-over scan, new-power step, new gear step, automation pass, and guide updates.
