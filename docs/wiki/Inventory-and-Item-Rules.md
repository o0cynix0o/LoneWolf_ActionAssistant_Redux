...
Lone Wolf inventory is tracked by category.
...
Lone Wolf can carry two Weapons.

If you already have two Weapons, the app will not silently add a third. Drop a Weapon first if the book gives you a new one and you want to keep it.

Weaponskill matters only when your chosen Weaponskill Weapon is actually the active weapon.
