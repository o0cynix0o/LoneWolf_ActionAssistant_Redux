...
|3|The Caverns of Kalte|User-installed Project Aon HTML|Setup, source routes, section helpers, combat presets, death/failure recovery, completion, saves|Implemented|Onboarding helper build; needs more route work|
|4|The Chasm of Doom|User-installed Project Aon HTML|Setup, source routes, section helpers, combat presets, item-loss helpers, death recovery, completion, saves|Implemented|Onboarding helper build; needs real-route testing|
|5|Shadow on the Sand|User-installed Project Aon HTML|Setup, source routes, section helpers, combat presets, item-loss helpers, safekeeping, death/failure recovery, completion, saves|Implemented|Onboarding helper build; needs real-route testing|
...
This is an onboarding helper build, not a release candidate. The next useful step is more route work and real playtesting so the guide and helper labels keep getting sharper.
