...
Book 3, **The Caverns of Kalte**, has its playable helper build in place. It supports Book 2 -> Book 3 continuation, standalone Book 3 setup, source routes, item helpers, combat presets, mission failure/death recovery, completion, repeat-book reset, first-pass achievements, and a player-facing strategy guide. Keep treating it as a helper build until broader human route testing says it is ready to package.

Book 4, **The Chasm of Doom**, now has its playable helper build in place. It supports Book 3 -> Book 4 continuation, standalone Book 4 setup, source routes, confirmed simple section effects, route checks, random helpers, loss-choice helpers, loot buttons, combat presets, death recovery, completion, repeat-book reset, first-pass achievements, and a player-facing strategy guide. Keep treating it as a helper build until human route playtesting finishes polish.

Book 5, **Shadow on the Sand**, now has its playable helper build in place. It supports Book 4 -> Book 5 continuation, standalone Book 5 setup, Special Item safekeeping, source routes, confirmed simple section effects, route checks, random helpers, loss-choice helpers, loot buttons, combat presets, death/failure recovery, completion, repeat-book reset, first-pass achievements, and a player-facing strategy guide. Keep treating it as a helper build until human route playtesting finishes polish.
...
Fan-wiki polish pass:

- `testing\logs\LWBOOK1_FANDOM_POLISH_REVIEW.md` through `testing\logs\LWBOOK5_FANDOM_POLISH_REVIEW.md` record secondary fandom context used for polish only.
- `docs\wiki\Book-3-Strategy-Guide.md`, `docs\wiki\Book-4-Strategy-Guide.md`, and `docs\wiki\Book-5-Strategy-Guide.md` are now present.
- Books 3-5 have first-pass achievement definitions, wiki achievement-guide entries, and coverage in `testing\lwbook345_achievement_smoke.py`.
- The inventory UI now badges known series/key items so carried campaign objects are easier to spot without changing the Project Aon reader pane.
